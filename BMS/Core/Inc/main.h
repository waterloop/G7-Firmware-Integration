...
/* Exported types ------------------------------------------------------------*/
/* USER CODE BEGIN ET */
#define NUM_MUX 3U     //Note: the number of multiplexors must also be changed in the ADC3 configuration
...
extern uint32_t adc_data[NUM_MUX];
...
#define MUX_SEL_A_GPIO_Port GPIOB
